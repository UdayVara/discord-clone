...
function ChatBody() {
  ...
  return (
    <div
      ref={chatContainer}
      className={`chat-body max-h-full  px-2 grow flex flex-col  overflow-y-scroll py-4 ${
        chats && chats.length < 12 ? "justify-end" : ""
      }`}
    >
            ...
            return (
              <div
                ...
                className={`flex flex-row items-start gap-2 ${
                  chat.fileurl ? "items-end" : "items-start"
                }`}
              >
                ...
                <div className="flex flex-col">
                  ...
                  {chat.fileurl && (
                    <Image
                      ...
                      height={1000}
                      alt="Failed To Load"
                      className="rounded md-w-[70%] w-[99%] max-w-[300px] md-mx-0 mx-auto object-contain h-auto  p-5"
                    />
                  )}
